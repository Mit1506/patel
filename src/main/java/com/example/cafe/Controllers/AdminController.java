...
public class AdminController {
    ...
    public ResponseEntity<List<ProductDto>> getAllProductsById(@PathVariable Long productId) {
        List<ProductDto> productDtoList = adminService.getAllProductsById(productId);
    ...
    public ResponseEntity<List<ReservationDto>> getReservation() {
    	List<ReservationDto> reservationDtoList = adminService.getReservation();
